...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\Column(length: 75)]
    private ?string $lastnameFirst = null;

    #[ORM\Column(length: 75)]
    private ?string $lastnameLast = null;
    ...
    public function setLastnameFirst(string $lastnameFirst): User
    {
    ...
    public function getLastnameLast(): ?string
    {
        return $this->lastnameLast;
    }

    public function setLastnameLast(string $lastnameLast): User
    {
